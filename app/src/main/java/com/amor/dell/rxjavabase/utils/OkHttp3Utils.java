...
public class OkHttp3Utils {
    ...
    public static OkHttpClient getOkHttpClient() {
        ...
        if (null == mOkHttpClient) {
            try {
                HttpUtils.SSLParams sslParams=HttpUtils.getSslSocketFactory(new InputStream[] {MyApplication.getInstance().getAssets().open("jiemica.crt")},
                        null, null);
    ...
    private static class MyIntercepter implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            Log.e("niu","response body:" + content);//输出返回信息
